window.addEventListener("load", () => {
  ...
  }, 3000); // Reduzi para 3 segundos o tempo de espera para melhorar a experiência
});
...
const previsoesLimitadas = previsoes.slice(0, 8);  
...
// Filtra as previsões para obter uma por dia
...
Object.keys(previsaoPorDia).forEach(dia => {
    ...
    `;
    previsaoSemanaContainer.innerHTML += previsaoBloco;  // Adiciona ao container
});
}
